...
__decorate([
    (0, typeorm_1.ManyToOne)(type => survey_entity_1.SurveyEntity, survey => survey.user),
    (0, typeorm_1.JoinColumn)({ name: 'surveyId', referencedColumnName: "id" }),
    __metadata("design:type", survey_entity_1.SurveyEntity)
], UserEntity.prototype, "survey", void 0);
