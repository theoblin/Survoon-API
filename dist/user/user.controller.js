...
let UserController = class UserController {
    ...
    async getOneUser({ type, searchValue }) {
    }
    async updateOneUser(newUserData) {
    }
    async createOneUser(createUserData) {
        return this.userService.createOneUser(createUserData);
    }
    async deleteOneUser(deleteUserData) {
    }
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'The user has been successfully updated.' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Forbidden.' }),
    (0, common_1.Put)(),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserController.prototype, "createOneUser", null);
__decorate([
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'The user has been successfully logged.' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Forbidden.' }),
